            ...
            <div class="col-12 col-md-8 text-light mt-5">
                ...
                <form wire:submit ="store">
                    <div class="mb-3">
                        ...
                        <input wire:model.live.debounce.100ms="title" type="text" class="form-control" id="title">
                    ...
                    <div class="mb-3 d-flex flex-column">
                        ...
                        <input wire:model.live.debounce.100ms="subtitle" type="text" class="form-control" id="subtitle">
                    ...
                    <div class="mb-3 d-flex flex-column">
                        ...
                        <textarea wire:model.live.debounce.100ms="body" id="body" class="form-control" cols="30" rows="5"></textarea>
